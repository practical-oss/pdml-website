[ch (id=maps) [title Maps]
    ...
    [note
        A PDML parser does not generate an error or warning if a map contains duplicate keys (see [link (url="^[ins-const core_spec_url]#duplicate_tags") Duplicate Tags] for more information).
