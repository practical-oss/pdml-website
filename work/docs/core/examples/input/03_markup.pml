[ch (id=markup) [title Markup]
    ...
    [note
        ...
        For a more complete markup example you may have a look at the [link (url="^[ins_const github_repo_url]/work/docs/core/examples") PML source code] of this document.
